  ...
  return (
    <Box sx={{
      ...
      <Box sx={{
        ...
        <Typography variant="h1" sx={{ fontSize: '55px', fontWeight: 800 }}>AccessDenied</Typography>
        <Typography sx={{ fontSize: '18px !important', lineHeight: '25px', fontWeight: 400, maxWidth: '350px', textAlign: 'center' }}>
          ...
          &nbsp;?<br />Hmm, looks like you do not have permission to access this page.
        </Typography>
        <Box sx={{ width: '390px', height: '390px', position: 'relative' }}>
          ...
          <SvgIcon component={PlanetSvg} inheritViewBox sx={{
            width: '100%', height: '100%', position: 'absolute', top: 0, left: 0
          }} /><PlanetSvg sx={{ width: '100%', height: '100%' }} />
        </Box>
